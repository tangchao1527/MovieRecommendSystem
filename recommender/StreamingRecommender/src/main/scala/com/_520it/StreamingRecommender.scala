...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //定义kafka连接参数
    val kafkaParm = Map(
      "bootstrap.servers" -> "192.168.137.129:9092",
    ...
    val kafkaStream =KafkaUtils.createDirectStream[String,String](ssc,
      ...
      ConsumerStrategies.Subscribe[String, String]( Array(config("kafka.topic")), kafkaParm )
    )
