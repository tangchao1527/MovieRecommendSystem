...
object DataLoader {
  ...
  // 定义常量
  val MOVIE_DATA_PATH = "D:\\idea_workspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\movies.csv"
  val RATING_DATA_PATH = "D:\\idea_workspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\ratings.csv"
  val TAG_DATA_PATH = "D:\\idea_workspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    //创建sparkConf对象
    val sparkConf = new SparkConf().setMaster(conf("spark.cores")).setAppName("DataLoader")
   ...
   storeDataInMongoDB(movieDF, ratingDF, tagDF)
    ...
    implicit val esConfig = ESConfig(conf("es.httpHosts"), conf("es.transportHosts"), conf("es.index"), conf("es.cluster.name"))
